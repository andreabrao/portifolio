(() => {
    ...
    const translations = {
        pt: {
            ...
            hero_showcase_tag: "Projeto real em produção",
            hero_project_link: "Visitar loja online",
            ...
            tag_vanilla: "HTML · CSS",
            tag_js: "JavaScript",
            tag_php: "PHP",
            tag_mysql: "MySQL",
            tag_api: "APIs REST",
            tag_database: "Banco de dados",
            tag_git: "Git · GitHub",
            ...
            case1_category: "E-commerce de alimentação saudável",
            case1_title: "Uma plataforma real, pronta para vender e operar.",
            case1_desc: "Site publicado para a Detox Orange, com catálogo, prova social e uma jornada direta até a compra.",
            case1_goal: "Destacar os produtos e reduzir o caminho até o pedido",
            case1_delivery: "Aplicação Full Stack com loja, API Node.js, pagamentos, pedidos e painel administrativo.",
            case1_link: "Visitar projeto real",
            case1_open: "Abrir site real",
            ...
            compact2_category: "Mentoria e lançamento",
            compact2_desc: "Oferta complexa organizada em uma landing page editorial e responsiva.",
            ...
            tooltip_vanilla: "Estrutura e apresentação de interfaces responsivas para a web.",
            tooltip_js: "Interações, comportamento da interface e lógica executada no navegador.",
            tooltip_php: "Back-end, regras de negócio, autenticação e processamento no servidor.",
            tooltip_mysql: "Banco de dados relacional para armazenar e organizar informações.",
            tooltip_api: "Criação e integração de serviços para comunicação entre sistemas.",
            tooltip_database: "Modelagem, armazenamento, consulta e gerenciamento de dados.",
        ...
        en: {
            ...
            hero_showcase_tag: "Live production project",
            hero_project_link: "Visit the online store",
            ...
            case1_category: "Healthy food e-commerce",
            case1_title: "A real platform, ready to sell and operate.",
            case1_desc: "A published website for Detox Orange, with a product catalog, social proof and a direct path to purchase.",
            case1_goal: "Highlight products and shorten the path to ordering",
            case1_delivery: "Full Stack application with a store, Node.js API, payments, orders and an admin dashboard.",
            case1_link: "Visit live project",
            case1_open: "Open live website",
            ...
            compact2_category: "Mentoring and launch",
            compact2_desc: "A complex offer organized into an editorial, responsive landing page.",
            ...
            tooltip_vanilla: "Structure and presentation of responsive web interfaces.",
            tooltip_js: "Interactions, interface behavior and logic executed in the browser.",
            tooltip_php: "Back-end development, business rules, authentication and server-side processing.",
            tooltip_mysql: "Relational database used to store and organize information.",
            tooltip_api: "Creation and integration of services that connect different systems.",
            tooltip_database: "Data modeling, storage, querying and management.",
